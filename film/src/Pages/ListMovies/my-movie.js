...
class MyMovies extends Component {
  ...
  renderShowListMovies = () => {
    ...
    if (listMovies.length > 0) {
      listMovies = array.chunk(listMovies, 8);
  ...
  render() {
    return (
      <section className="myMovies myContainer" id="filmblock">
        <ul
...
export default connect(mapStateToDrops, mapDispatchToDrops)(MyMovies);
